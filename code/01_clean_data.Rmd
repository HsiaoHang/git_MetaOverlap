...
This script cleans the datasets. Note that data of the Baltic Sea is included in data preparation but is not used for publication, because of the limit in the number of populations in this region for testing two of three hypotheses.
