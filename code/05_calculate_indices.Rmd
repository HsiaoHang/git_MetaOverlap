...
This script compiles cpue data.
...
# save cpue.length.subarea.yearqua & cpue.year
```{r}

write.csv(cpue.length.subarea.yearqua, "output/cpue.length.subarea.yearqua.csv",row.names=F)

write.csv(cpue.year, "output/cpue.year.csv",row.names=F)
