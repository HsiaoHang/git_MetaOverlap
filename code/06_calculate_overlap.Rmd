...
This script is to calculate spatial ovelap between size group pairs. Results of spatial overlap index is not presented in the paper.
...
#<without loop>: Compile overlap data (cpue.year/cpue.pair) (5 lengthgroup, cut off = 1% and 99%)
```{r}
group.num = 5
cutoff = 1
...
write.csv(cpue.pair, 'output/cpue.pair.csv')
